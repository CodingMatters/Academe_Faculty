...
namespace Academe\FacultyTest\Page;

use Academe\Faculty\Page\ProfilePage as ViewPage;
...
class ProfilePageTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testResponse()
    {
        ...
        $response = $page(new ServerRequest(['/student/profile']), new Response(), function () {
        });
